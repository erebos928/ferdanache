<%-- 
    Document   : confirmInscription
    Created on : 15 nov. 2016, 07:47:04
    Author     : Mohamed
--%>
                ...
                <div class="container">
                    <div class="span8">
                        ...
                        <div class="contenu-pages">
                            ...
                            <h1>Félicitations !</h1>
                            <h3>Vous êtes inscrit dans l'activité suivante :</h3>

                            <ul>
                                <li>Activité : ${requestScope.selectedActivity}</li>
                                <li>Date : ${requestScope.selectedDate}</li>
                                <li>Horaire : ${requestScope.selectedCreneau}</li>
